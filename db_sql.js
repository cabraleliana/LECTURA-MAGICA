...
module.exports = class Sql {
    constructor(stringConnection) {
        ...
        this.pool = null; // este es mi contructor , recibe la configuracion a la base (un objeto) cuando lo recibe no hace falta que le especifiqie el tipo de dato que recibe 
        //this son variables generales de la clase que voy a pooder acceder desde cualquier metodo
    }
